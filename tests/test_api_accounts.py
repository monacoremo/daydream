...
def test_login_wrong_email(
    service_endpoint, alice_account, alice_email, alice_password
):
    "Logins with wrong emails should fail."

    resp = requests.post(
        f"{service_endpoint}/api/rpc/login",
        json={"email": "wrong_" + alice_email, "password": alice_password,},
    )
...
def test_login_wrong_password(
    ...
    resp = requests.post(
        f"{service_endpoint}/api/rpc/login",
        json={"email": alice_email, "password": "wrong_" + alice_password,},
    )
